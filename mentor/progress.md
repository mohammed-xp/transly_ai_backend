...
- **التاسك المفتوحة:** 🚧 **TASK-010 — أول EF Core: كاش الترجمات** (اتكتبت 2026-08-27). الملف: `mentor/tasks/TASK-010.md`.
...
| M3 | EF Core | 🚧 **هنا** | TASK-010: **كاش الترجمات** — نفس النص+الزوج+النبرة مايتشتراش مرتين. الدافع مزدوج: الـ quota عايق فعلي، والكاش هو نفسه مكسب إنتاجي حقيقي. الـ history مؤجّل لأنه محتاج identity (M5) |
...
| M7 | Testing | 🚧 **اتقدّمت — هنا، وTASK-009 آخر واحدة فيها** | TASK-008 ✅: الـ seam هو `HttpMessageHandler` مش interface (قرار #15 قايم). TASK-009 🚧: سدّ الحدود اللي بتسرّب exception + الـ stub يقرا الـ request (الـ prompt/tone/`store:false`). `WebApplicationFactory` (outcome → status code) اتأجلت لـ M4 مع الـ error contract |
...
> **الحالة بتاريخ 2026-08-27:** TASK-008 اتقفلت · TASK-009 اتلغت بطلبه · **TASK-010 اتقفلت (Approved، الأربعة بنود اتقفلوا r3)**.
>
> ## 🛑 وقوف — مفيش تاسك لحد ما يطلب
>
> **ابدأ الجلسة الجاية من غير ما تفتح موضوع تاسك خالص.** القاعدة الثابتة فوق.
>
> **اللي مفتوح فعلياً ومش محتاج تاسك جديدة:**
> - ⏳ **TASK-010 لسه ماتكوميتش.** الـ working tree نضيف وجاهز، `git log` آخره `77bba27`.
> - ⬜ سؤالين تجريبيين من TASK-010: `"Hello"` vs `"hello"` (درس الـ collation)، وعدد الـ SQL statements في المرة التانية.
>
> **لو طلب تاسك:** مفيش حاجة مكتوبة مقدماً — **اسأله الأول** هو عايز يشتغل في إيه، وبعدين اكتب. الحاجة الوحيدة المسجّلة كأولوية فنية هي **تثبيت اسم الموديل** (اتنقل من M8 بعد ما قرار #18 اتقلب) — بس دي **مادة خام مش ticket**، ومتتحولش لتاسك إلا بطلب منه.
>
