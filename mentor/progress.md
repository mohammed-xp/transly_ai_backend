...
**آخر تحديث:** 2026-08-31 (review TASK-013 r3 = Approved · assign TASK-014)
...
- **التاسك المفتوحة:** ✅ **TASK-014 اتقفلت — Approved (2026-08-31)، صفر blockers**. لسه **متكوميتتش** وقت كتابة السطر ده. الملف: `mentor/tasks/TASK-014.md`.
...
- **🛑 مفيش TASK-015 من غير ما يطلبها بالكلام.**
...
>
> **⬜ مادة جاهزة لتاسك — متتفرضش:** integration tests بـ `WebApplicationFactory` + داتابيز حقيقية، تغطي (2 مستخدمين / نفس النص / صف كاش واحد) و(401 من غير توكن). دي الحاجة اللي بتحوّل سبع مرات من الـ curl اليدوي لتيست بيشتغل لوحده. **M7 راجعة ليها سبب حقيقي المرة دي.**
>
